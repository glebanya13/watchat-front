...
import 'package:watchat/features/call/screens/call_pickup_screen.dart';
import 'package:watchat/features/chat/widgets/bottom_chat_field.dart';
import 'package:watchat/models/user_model.dart';
import 'package:watchat/features/chat/widgets/chat_list.dart';
                  ...
                  builder: (context, snapshot) {
                    ...
                    return Column(
                      children: [
                        Text(name),
                        Text(
                          snapshot.data!.isOnline ? 'в сети' : 'не в сети',
